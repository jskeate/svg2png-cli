...
module.exports = function svgToPng(sourceFileName, destFileName, scale, fillColor, strokeColor, cb) {
    if (typeof scale === "function") {
        cb = scale;
        scale = 1.0;
    }

    var args = [converterFileName, sourceFileName, destFileName, scale, fillColor, strokeColor];
